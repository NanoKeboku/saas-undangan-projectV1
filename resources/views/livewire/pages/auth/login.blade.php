            ...
            <form wire:submit.prevent="authenticate" class="space-y-5">
                ...
                <div class="space-y-1">
                    ...
                    <input type="email" wire:model.lazy="email" autofocus required
                        class="w-full px-5 py-4 bg-slate-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white rounded-2xl text-sm font-semibold transition outline-none @error('email') border-red-500 @enderror"
